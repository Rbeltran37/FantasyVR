...
*
* This class has been originally written by Bunny83
*
=====================================================*/
...
namespace TB{
    ...
    public static class MeshExtension{
        ...
        public static Mesh[] GetAllSubmeshes(this Mesh mesh) {
            Mesh[] meshes = new Mesh[mesh.subMeshCount];
            for (int i = 0; i < meshes.Length; i++) {
                meshes[i] = mesh.GetSubmesh(i);
            }
